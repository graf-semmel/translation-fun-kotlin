package android.grafsemmel.translationfun.translationfunkotlin.view
...
class ShowMostRecentActivityTest {
  ...
  private fun clickOnRecentButton() {
    val appCompatButton = onView(allOf(ViewMatchers.withId(R.id.btn_recent), withText("Show All"),
